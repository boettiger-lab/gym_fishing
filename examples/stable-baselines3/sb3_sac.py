...
for i in range(1):
    ...
    model = SAC("MlpPolicy", env, verbose=2, learning_rate=0.001, batch_size=16, buffer_size=1000, train_freq=8, tau=0.01, ent_coef=0.004, gamma=0.995, policy_kwargs=policy_kwargs)
