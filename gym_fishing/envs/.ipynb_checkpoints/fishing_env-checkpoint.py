...
class FishingEnv(gym.Env):
    ...
    def population_draw(self):
        ...
        self.fish_population = max(
            ...
            floor(
                ...
                + self.r * self.fish_population * (1 - self.fish_population / self.K)
    ...
    def step(self, action):
        ...
        assert action % 1 == 0 and action >= 0, "%r (%s) invalid" % (
            action,
            type(action),
        )
    ...
    def render(self, mode="human"):
        ...
        if self.viewer is None:
            ...
            dock = rendering.FilledPolygon(
                [(left, bottom), (left, top), (right, top), (right, bottom)]
            )
            dock.set_color(0.8, 0.6, 0.4)
